// Asks FantasyPros whether "Sleepers" — their curated list of undervalued/
// breakout candidates, published as an article on fantasypros.com each
// preseason and updated through the year — is reachable as ranking DATA
// behind the partner API key this project already holds, the same way
// DYNASTY/DRAFT/ROS/WEEKLY/ADP already are (see rankingSpecForLeague in
// scripts/lib/fantasypros.mjs, all four confirmed working today).
//
...
const typeCandidates = ['SLEEPER', 'SLEEPERS', 'BREAKOUT', 'BREAKOUTS'];
